  ...
  function getAmbientPalette() {
    ...
    if (isLight) {
      return {
        ...
        composite: "multiply",
        grid: "rgba(4,120,87,.12)",
        gridAlpha: .4,
        line: "rgba(4,120,87,.28)",
        lineAlpha: .56,
        node: "rgba(6,95,70,.84)",
        nodeAlpha: .9,
        nodeGlow: ["rgba(16,185,129,.2)", "rgba(52,211,153,.17)", "rgba(4,120,87,.14)"],
        packet: ["rgba(4,120,87,.86)", "rgba(16,185,129,.78)", "rgba(52,211,153,.64)"],
        packetAlpha: .78,
        code: "rgba(6,95,70,.38)",
        codeAlpha: .52,
      };
    }
    ...
    return {
      ...
      composite: "screen",
      grid: "rgba(16,185,129,.1)",
      gridAlpha: .34,
      line: "rgba(16,185,129,.22)",
      lineAlpha: .5,
      node: "rgba(52,211,153,.72)",
      nodeAlpha: .86,
      nodeGlow: ["rgba(16,185,129,.22)", "rgba(52,211,153,.18)", "rgba(4,120,87,.14)"],
      packet: ["rgba(52,211,153,.78)", "rgba(16,185,129,.7)", "rgba(4,120,87,.62)"],
      packetAlpha: .72,
      code: "rgba(167,243,208,.22)",
      codeAlpha: .36,
    };
  }
